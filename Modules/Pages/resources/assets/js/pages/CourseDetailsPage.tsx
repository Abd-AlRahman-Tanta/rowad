...
const CourseDetailsPage = ({ allData }: { allData: any }) => {
  ...
  return (
    <PageContentProvider pageName="Course">
      <div className="pb-16 pt-32 relative bg-arch-accent/10">
        <div className="px-largeSaveSpace max-desc:px-mobSaveSpace ">
          ...
          <div className="relative z-10">
            <div className="bg-arch-card rounded-3xl overflow-hidden shadow-xl grid grid-cols-1 desc:grid-cols-2 content-center">
              <div className="p-8 max-mob:p-6 text-arch-dark">
                <Image
                  src={course.image}
              ...
              <div className="p-8 max-mob:p-6 desc:border-s border-gray-300">
                {course.newCourse && (
        ...
        <div className="relative pt-16 overflow-hidden  ">
          <div className="mb-8 px-largeSaveSpace max-desc:px-mobSaveSpace">
